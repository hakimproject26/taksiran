...
terhadap vektor ujian rasmi RFC 8032, dan disilang-periksa dengan openssl
pada SETIAP binaan (lihat `alat/tanda.py sahkan`, dipanggil `bina.sh`).
Ia tidak dibiarkan tidak diuji.
...
KUNCI = [
    # Kunci tuan. Kunci rahsia yang sepadan ada di ~/.taksiran-kunci/kunci.pem,
    # disulitkan dengan frasa laluan. Cap jari: 2bef 1825 e0ff 26e2 …
    bytes.fromhex("2bef1825e0ff26e22ed0206bcbe4622f3d4b308e88ee328347770444ab86cc9b"),
]
